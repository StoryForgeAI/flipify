...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="border-b border-white/10 bg-slate-950 px-5 py-8 sm:px-8">
        <div className="grid gap-6 xl:grid-cols-[1fr_360px]">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300">
              Your AI resale cockpit is ready for today&apos;s flips. Use tools for quick wins, save credits for higher-value AI actions, and export polished listings to eBay.
            </p>
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/products" className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/10 px-5 py-3 text-sm font-bold text-white transition hover:bg-white/15">
                View inventory
              </Link>
            </div>
          </div>
          <div className="rounded-xl border border-blue-300/30 bg-blue-400/15 p-5">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <div className="rounded-lg bg-white/10 p-3">
                ...
                <p className="mt-2 text-sm font-bold text-white">1-2 tool tries</p>
              </div>
              <div className="rounded-lg bg-white/10 p-3">
                <TrendingUp className="h-4 w-4 text-emerald-600" />
                <p className="mt-2 text-sm font-bold text-white">Templates need Pro</p>
              </div>
            </div>
          </div>
        </div>
